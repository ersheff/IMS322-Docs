...
In this class, the objective for wireframes is to create a detailed visual representation that closely matches the desired final product, including the actual image files that will be used. Your wireframes should also include annotations for the following:
